...
cursor.execute(''' INSERT INTO customers (customer_id, customer_name) VALUES (1, 'Tony Stark');''')
cursor.execute('''INSERT INTO customers (customer_id, customer_name) VALUES (2, 'Matt damon');''')
cursor.execute('''select *from customers;''')
print(cursor.fetchall())

cursor.execute('''INSERT INTO orders (order_id, customer_id, order_date) VALUES (1, 5, '2023-04-02');''')  
